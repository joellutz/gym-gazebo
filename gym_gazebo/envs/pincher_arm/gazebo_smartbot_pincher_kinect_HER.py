...
class GazeboSmartBotPincherKinectEnv(gazebo_env.GazeboEnv, gym.GoalEnv):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Dict(dict(
            ...
            observation=spaces.Box(low=0, high=255, shape=[220*300], dtype=np.uint8),
        ))
        ...
        boundaries_yaw = [0, 2*np.pi]       # box position possiblities: (0, np.pi)
        ...
        self.insertObject(0.4, 0, 0.025/2,
            "/home/joel/Documents/pluginTest/smartBot_plugin/models/tablePlane/tablePlane.sdf", "tablePlane")

        print("inserting kinect sensor")
        self.insertObject(0.03, 0, 0.5,
            "/home/joel/Documents/pluginTest/smartBot_plugin/models/kinect_ros/model.sdf", "kinect_ros", roll=0, pitch=np.pi/2, yaw=0)

        print("inserting object to pick up")
        self.insertObject(0.1, 0, 0.1,
            "/home/joel/Documents/pluginTest/smartBot_plugin/models/objectToPickUp/objectToPickUp.sdf", "objectToPickUp")
    ...
    def step(self, action):
        ...
        print(text)
        success = self.moveArmToPose(self.createPose(x, y, z, roll, pitch, yaw))
    ...
    def read_kinect_depth_image(self, setRandomPixelsToZero=False, saveImage=False, folder="/home/joel/Pictures/"):
        data = None
        cv_image = None
        ...
        if(saveImage):
            ...
            # f = open("/home/joel/Documents/depth_image_simulation.txt", "w")
            # print >>f, image
            # f.close()
